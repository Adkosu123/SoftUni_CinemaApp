...
namespace CinemaApp.Data.Utilities
{
    public class EntityValidator : IValidator
	{
		...
		{
			// Clean the Error Messages left from the previous validation.
			this.errorMessages = new List<string>();

			// Build ValidationContext and initialize collection for the Validation Result
			...
			foreach (var result in validationResults)
			{
				...
				{
					// Add the ErrorMessage to the field, containing the current validation message.
